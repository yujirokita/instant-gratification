...
train_score(use_pseudo=False, use_synthetic=False, gen_samples=False)
...
# train, score, and sample
train_score(use_pseudo=True, use_synthetic=False, gen_samples=True, n_samples_per_component=200)
